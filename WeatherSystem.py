...
class WeatherSystem:
    ...
    def __init__(self, woeid):
        ...
        self.lowTemp, self.highTemp, self.currentTemp = 0, 0, 0
    ...
    def loadWeather(self):
        url = 'http://weather.yahooapis.com/forecastrss?u=f&w=' + self.woeid
    ...
    def gatherData(self):
        ...
        self.lowTemp = self.gatherWeatherTempLow()
        self.highTemp = self.gatherWeatherTempHigh()
    ...
    def gatherWeatherTempHigh(self):
        yweatherForecastList = self.xmlDoc.getElementsByTagName('yweather:forecast') 
    ...
    def gatherCurrentTemp(self):
        yWeatherCurrentConditions = self.xmlDoc.getElementsByTagName('yweather:condition')
        weatherCurrentTemp = yWeatherCurrentConditions[0].attributes['temp'].value
		
        return weatherCurrentTemp
	#  Returns current conditions	
    def gatherCurrentCondition(self):
        yWeatherCurrentConditions = self.xmlDoc.getElementsByTagName('yweather:condition')        
        weatherCurrentCondition = yWeatherCurrentConditions[0].attributes['text'].value
